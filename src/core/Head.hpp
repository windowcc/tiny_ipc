...
template <typename Policies, bool = RelationTrait<Policies>::is_broadcast>
class Head;

template <typename Policies>
class Head<Policies, true> : public ConnHeadBase
{
public:
...
template <typename Policies>
class Head<Policies, false> : public ConnHeadBase
{
public:
    uint32_t connect() noexcept
    {

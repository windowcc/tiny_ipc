...
template <>
class Policies<Wr<Relation::SINGLE, Relation::SINGLE, Transmission::UNICAST>>
{
public:
...
template <>
class Policies<Wr<Relation::MULTI, Relation::SINGLE, Transmission::UNICAST>>
: public Policies<Wr<Relation::SINGLE, Relation::SINGLE, Transmission::UNICAST>>
{
public:
template <std::size_t DataSize, std::size_t AlignSize>
struct elem_t
...
template <>
class Policies<Wr<Relation::SINGLE, Relation::MULTI, Transmission::BROADCAST>>
{
public:
enum : uint64_t
{
...
template <>
class Policies<Wr<Relation::MULTI, Relation::MULTI, Transmission::BROADCAST>>
{
public:
enum : uint64_t
{

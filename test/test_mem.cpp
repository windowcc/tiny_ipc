...
struct alloc_Random : alloc_ix_t<alloc_Random> {
    static void init() {
        random<> rdm_index(0, LoopCount - 1);
        for (int i = 0; i < LoopCount; ++i) {
...
// };
/*
TEST(Memory, StaticAlloc) {
    test_performance<ipc::detail::StaticAlloc, void        , ThreadMax>::start("alloc-free");
    test_performance<ipc::detail::StaticAlloc, alloc_FIFO  , ThreadMax>::start("alloc-FIFO");
    test_performance<ipc::detail::StaticAlloc, alloc_LIFO  , ThreadMax>::start("alloc-LIFO");
    test_performance<ipc::detail::StaticAlloc, alloc_Random, ThreadMax>::start("alloc-Rand");
}

TEST(Memory, PoolAlloc) {
    test_performance<ipc::detail::PoolAlloc, void        , ThreadMax>::start("alloc-free");
    test_performance<ipc::detail::PoolAlloc, alloc_FIFO  , ThreadMax>::start("alloc-FIFO");
    test_performance<ipc::detail::PoolAlloc, alloc_LIFO  , ThreadMax>::start("alloc-LIFO");
    test_performance<ipc::detail::PoolAlloc, alloc_Random, ThreadMax>::start("alloc-Rand");
}
*/
